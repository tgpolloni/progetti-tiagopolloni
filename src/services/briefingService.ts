  ...
  async getAllBriefings(): Promise<BriefingFormData[]> {
    try {
      ...
      return data.map(briefing => ({
        id: briefing.id,
        nomeCompleto: briefing.nome_completo,
        email: briefing.email,
        telefono: briefing.telefono,
        nomeAzienda: briefing.nome_azienda,
        codiceFiscaleOrPIVA: briefing.codice_fiscale_or_piva || '',
        ruolo: briefing.ruolo || '',
        obiettivoProgetto: briefing.obiettivi || '',
        giaEsistente: briefing.gia_esistente || '',
        scadenzaSpecifica: briefing.scadenza_specifica,
        tipoProgetto: briefing.tipo_progetto,
        tipoProgettoAltro: briefing.tipo_progetto_altro,
        ambito: briefing.ambito || 'Completo (front-end + back-end)',
        funzionalitaNecessarie: briefing.funzionalita_necessarie || '',
        funzionalitaPrincipali: briefing.funzionalita_principali || '',
        funzionalitaSecondarie: briefing.funzionalita_secondarie,
        livelliUtenti: briefing.livelli_utenti,
        areeRiservate: briefing.aree_riservate,
        designEsistente: briefing.design_esistente || 'No – serve creazione',
        sitiRiferimento: briefing.siti_riferimento,
        paletteColori: briefing.palette_colori,
        logoReady: briefing.logo_ready || false,
        serviziEsterni: briefing.servizi_esterni,
        piattaforme: briefing.piattaforme || [],
        preferenzeTecniche: briefing.preferenze_tecniche,
        contenutiPronti: briefing.contenuti_pronti,
        modalitaInvio: briefing.modalita_invio,
        importazioneAltroSistema: briefing.importazione_altro_sistema,
        haiDominio: briefing.hai_dominio || false,
        haiHosting: briefing.hai_hosting || false,
        serveAssistenza: briefing.serve_assistenza || false,
        tipoSupporto: briefing.tipo_supporto || 'Nessun supporto',
        budgetStimato: briefing.budget_stimato,
        modalitaPagamento: briefing.modalita_pagamento || 'A fasi',
        scadenzaFinale: briefing.scadenza_finale,
        partiUrgenti: briefing.parti_urgenti,
        dataLancio: briefing.data_lancio,
        informazioniAggiuntive: briefing.informazioni_aggiuntive,
        restrizioniNormative: briefing.restrizioni_normative,
        projectId: briefing.project_id,
        clientId: briefing.client_id,
        projectName: briefing.projects?.nome_progetto || 'Briefing Público'
      })) as BriefingFormData[];
    } catch (error) {
